...
<html>
	<head>
		...
		<title>Flujo de Votantes - Módulo 3</title>
		<link relQuery Mobile Bootstrap ="stylesheet" href="themes/Bootstrap.css">
	...
	<body>
		<div data-role="page" data-theme="a">
			<div data-role="header" data-position="inline">
				<h1>Flujo de Votantes - Módulo 3</h1>
				<div data-role="navbar">
					<ul>
						<li><a href="index.html" data-icon="home" class="ui-btn-active">Datos Iniciales</a></li>
